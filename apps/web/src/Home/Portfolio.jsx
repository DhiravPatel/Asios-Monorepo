                  ...
                  <SwiperSlide key={item._id}>
                    ...
                    >
                      <Link to={`/main-product/${item._id}`} className="group block">
                        ...
                        {/* Editorial name plate below the image */}
                        <div className="mt-5 flex items-end justify-between gap-4">
                          <div className="min-w-0 flex-1">
                            ...
                            <h3 className="display text-2xl md:text-[28px] leading-tight capitalize group-hover:text-primary transition-colors duration-500">
                              {item.category}
                            </h3>
